		...
		<div data-aos="flip-left" className='Containers'>
			...
			<div className='FeatureWrapper'>
				...
				<Modal isOpen={modal2} toggle={toggle2}>
					...
					<ModalBody>
						Web dasturlash (kurslari). O'quv kurslari 2019-yil Mart oyida tashkil etilgan. 2019-2023-yillari May oyigacha IT da 1500 dan ortiq o'quvchilar Web dasturlash kurslarini to'liq o'qib sertifikat olib bitirishgan. 2022-yilda 5/4  o'quvchilar Web dasturlash kurslarida talim olgan va ulardan 4/6 nafari darslarni muvoffaqiyatli tamomlagan. Ulardan 120 dan ortig'i, yani 30% ishlarga joylashib o'z o'rinlarini topishgan, 250 dan ortig'i maktab o'quvchilari bo'lib va ularning 80% algoritm IT labaratoriyasida loyihalar bilan amaliyot o'tashmoqda. Masalan, eng faol o'quvchilarimizdan biri Ibrohim Jalolov, Amerikaning "Aveks dizayn" kompaniyasining Toshkentdagi filialida senior dasturchi sifatida faoliyat yuritmoqda. 2023 yilda "ALGORITM" 100 nafar yoshlarga IT Web dasturlashni o'rgatishni maqsad qilgan.
					</ModalBody>
				</Modal>
